...
def main() -> None:
    parser.add_argument("-h", "--help", action="help", default=argparse.SUPPRESS, help="Vous pouvezr simuler une marche aléatoire de N particules pendant n étapes, avec ou sans interface graphique et stocker la position finale dans un fichier texte.")
